/**
 * Filename: ptgrid.js
 * Generated 2016-07-22 at 04:50:49 AM
 */
/*!
        ...
        _layout = function($container, itemSelector, callback) {
			...
			*/
            ...
            summed_width = photos.reduce((function(sum, p) {
                if (aspect_ratio(p) <= .3 || aspect_ratio(p) >= 3) {
                    return sum += (ideal_height * aspect_ratio(p)) / 2.77;
                } else if (aspect_ratio(p) <= .4 || aspect_ratio(p) >= 2.5) {
                    return sum += (ideal_height * aspect_ratio(p)) / 2.31;
                } else if (aspect_ratio(p) <= .5 || aspect_ratio(p) >= 2) {
                    return sum += (ideal_height * aspect_ratio(p)) / 1.85;
                } else if (aspect_ratio(p) <= .65 || aspect_ratio(p) >= 1.5) {
                    return sum += (ideal_height * aspect_ratio(p)) / 1.38;
                } else if (aspect_ratio(p) <= .8 || aspect_ratio(p) >= 1.3) {
                    return sum += (ideal_height * aspect_ratio(p)) / 1.20;
                } else {
