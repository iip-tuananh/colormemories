...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('bang-gia.html','PageController@khuyenMai')->name('khuyenMai');
    Route::get('bang-gia/{slug}.html','PageController@detailKhuyenmai')->name('detailKhuyenmai');

    Route::get('video/{danhmuc}.html','PageController@listVideo')->name('listVideo');
    Route::get('video/{danhmuc}/{slug}.html','PageController@detailVideo')->name('detailVideo');
